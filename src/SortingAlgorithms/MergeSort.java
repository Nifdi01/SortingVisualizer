...
public class MergeSort implements SortingInterface {
    private int[] getSubArray(SortBars array, int begin, int size) {
    ...
    private void merge(SortBars array, int left, int middle, int right) {
    ...
    private void mergeSort(SortBars array, int left, int right) {
        if (left < right) {
    ...
    @Override
    public void runSort(SortBars array) {
        int left = 0;
